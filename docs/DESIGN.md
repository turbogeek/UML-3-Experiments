...
| UML3 palettes in CATIA Magic | `verifyPalettes.groovy` + `tools/check_palettes.py` | **10/10 views** (six compact, four detail) get their UML3 palette; all 45 templated buttons copy the expected element kind and keyword; the UML3 Create View dialog is active; 7 negative controls fail the check |
