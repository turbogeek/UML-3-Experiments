...
| Names, lint, keyword applicability | `tools/check_names.py` | library, examples and requirements pass; 22 negative tests fail as expected, including keyword rules inherited through imports |
...
| UML3 palettes (CATIA Magic customization) | `verifyPalettes.groovy`, `tools/check_palettes.py`, suite `catia-customization` | 6/6 views get their UML3 palette; 41 templated buttons copy the expected element kind and keyword; UML3 Create View dialog active; 7 negative controls |
...
* **Open design issues** found while documenting and writing the requirements are listed as I-01 to I-36 in [`docs/DESIGN.md`](docs/DESIGN.md); they are maintainer decisions and none is fixed yet.
